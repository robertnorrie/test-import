...
sed -i '' 's/version = "[0-9]*.[0-9]*"//g' modules/*/*.info themes/*/*.info themes/tests/*/*.info modules/*/*/*.info modules/*/*/*/*.info
sed -i '' 's/project = "drupal"//g' modules/*/*.info themes/*/*.info themes/tests/*/*.info modules/*/*/*.info modules/*/*/*/*.info
sed -i '' 's/datestamp = "[0-9]*"//g' modules/*/*.info themes/*/*.info themes/tests/*/*.info modules/*/*/*.info modules/*/*/*/*.info
sed -i '' '/^$/d' modules/*/*.info themes/*/*.info themes/tests/*/*.info modules/*/*/*.info modules/*/*/*/*.info
